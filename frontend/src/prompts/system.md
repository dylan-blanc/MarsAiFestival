...
- **INTERDIT** de créer un fichier à la racine de `src/` sauf `App.tsx` et `main.tsx`
...
- Les types partagés vont dans `types/`, les types locaux restent dans `feature/types.ts`
